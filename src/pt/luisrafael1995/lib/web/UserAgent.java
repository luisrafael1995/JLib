...
public final class UserAgent {
    ...
    private static Map<Browser, String[]> uaMap = new HashMap<>();
    private static Map<Browser, Double> freqMap = new HashMap<>();

    static {
        freqMap.put(Browser.INTERNET_EXPLORER, 11.8);
        freqMap.put(Browser.FIREFOX, 28.2);
        freqMap.put(Browser.CHROME, 52.9);
        freqMap.put(Browser.SAFARI, 3.9);
        freqMap.put(Browser.OPERA, 1.8);

        uaMap.put(Browser.INTERNET_EXPLORER, new String[]{
        ...
        uaMap.put(Browser.FIREFOX, new String[]{
        ...
        uaMap.put(Browser.CHROME, new String[]{
        ...
        uaMap.put(Browser.SAFARI, new String[]{
        ...
        uaMap.put(Browser.OPERA, new String[]{
    ...
    public static String getRandomUserAgent() {
        ...
        double count = 0.0;
        for (Entry<Browser, Double> freq : freqMap.entrySet()) {
            count += freq.getValue();
            if (rand <= count) {
                browser = freq.getKey();
                break;
        ...
        return getRandomUserAgent(browser == null ? Browser.CHROME : browser);
    }
